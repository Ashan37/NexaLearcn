...
const Dashboard = () => {
  ...
  const maxHours =
    learningActivity.length > 0
      ? Math.max(...learningActivity.map((a) => a.hours))
      : 1;
  const totalWeeklyHours = learningActivity.reduce(
    (sum, a) => sum + a.hours,
    0
  );
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="text-center">
          <div className="inline-block w-16 h-16 border-b-2 rounded-full border-emerald-600 animate-spin"></div>
                ...
                {activeCourses.length > 0 ? (
                  <div className="space-y-6">
                    {activeCourses.map((course) => (
                      <div
                        key={course.id}
                        className="overflow-hidden transition-shadow border border-gray-200 rounded-lg hover:shadow-lg"
                      >
                        <div className="flex flex-col sm:flex-row">
                          ...
                          <div className="flex-1 p-4">
                            <div className="flex items-start justify-between mb-2">
                              <div>
                                <span className="inline-block px-2 py-1 mb-2 text-xs font-semibold rounded text-emerald-700 bg-emerald-100">
                                  {course.category}
                                </span>
                            ...
                            <div className="mt-3">
                              ...
                              <div className="w-full h-2 mb-3 bg-gray-200 rounded-full">
                                <div
                                  className="h-2 transition-all duration-300 rounded-full bg-emerald-600"
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <button
                                  ...
                                  className="flex items-center px-4 py-2 text-sm font-semibold text-white transition-colors rounded-lg bg-emerald-600 hover:bg-emerald-700"
                                >
                  ...
                  <div className="py-12 text-center rounded-lg bg-gray-50">
                    ...
                    <a
                      href="/courses"
                      className="inline-flex items-center px-6 py-3 font-semibold text-white rounded-lg bg-emerald-600 hover:bg-emerald-700"
                    >
                  ...
                  <>
                    <div className="flex items-end justify-between h-64 space-x-4">
                      {learningActivity.map((activity, index) => (
                        ...
                        >
                          <div
                            className="relative w-full bg-gray-200 rounded-t-lg"
                            style={{ height: "100%" }}
                          >
                            <div
                              className="absolute bottom-0 w-full transition-all duration-500 bg-teal-600 rounded-t-lg hover:bg-teal-700"
                              style={{
            ...
            <div className="space-y-8">
              ...
              <div className="p-6 text-white rounded-lg shadow-md bg-gradient-to-br from-emerald-600 to-teal-600">
                ...
                <p className="mb-4 text-sm text-emerald-100">
                  Get instant help with your courses, personalized
                  recommendations, and study tips.
                </p>
                <button
                  onClick={handleAIChat}
                  className="w-full px-4 py-3 font-semibold transition-colors bg-white rounded-lg text-emerald-600 hover:bg-emerald-50"
                >
                  Start AI Chat
                </button>
              </div>
                ...
                {recommendedCourses.length > 0 ? (
                  <div className="space-y-4">
                    {recommendedCourses.map((course, index) => (
                      <div
                        key={course.id || index}
                        className="p-4 transition-all border border-gray-200 rounded-lg hover:border-emerald-300 hover:shadow-md"
                      >
                        ...
                        <a
                          href="/courses"
                          className="block w-full px-4 py-2 text-sm font-semibold text-center text-white transition-colors rounded-lg bg-emerald-600 hover:bg-emerald-700"
                        >
                          Enroll Now
                        </a>
                      </div>
