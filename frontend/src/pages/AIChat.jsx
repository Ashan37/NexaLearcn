...
const AIChat = () => {
  ...
  useEffect(() => {
    ...
    setMessages([
      {
        role: 'assistant',
        content: 'Hello! I\'m your AI Learning Assistant. I can help you with course recommendations, study tips, answer questions about various topics, and assist with your learning journey. How can I help you today?',
    ...
    try {
      ...
      if (response.ok) {
        const assistantMessage = {
          role: 'assistant',
          content: data.answer || data.message || 'I apologize, but I couldn\'t generate a response. Please try again.',
          timestamp: new Date().toISOString()
        };
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-indigo-100">Welcome back, {user.name}!</p>
              </div>
            </div>
            <button
      ...
      <div className="flex-1 w-full max-w-5xl px-4 py-8 mx-auto sm:px-6 lg:px-8">
        ...
        <div className="p-4 mt-6 border border-indigo-200 rounded-lg bg-indigo-50">
          <div className="flex gap-3">
            ...
            <div>
              <h3 className="mb-1 font-semibold text-indigo-900">How can the AI assist you?</h3>
              <ul className="space-y-1 text-sm text-indigo-700">
                <li>• Get personalized course recommendations based on your interests</li>
                <li>• Receive study tips and learning strategies</li>
                <li>• Ask questions about programming, design, or any subject</li>
